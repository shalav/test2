...
function renderTicker(ticker) {
    ...
    const changeNum = currentPrice - yesterdayClose;
    const change = ((changeNum) / yesterdayClose * 100).toFixed(2);
    ...
    priceDiv.className = changeNum >= 0 ? 'price-positive' : 'price-negative';
